...
//
//class NewBestDataManager {
//    let appDelegate = UIApplication.shared.delegate as! AppDelegate
//
//    func getRecommendedProduct(_ todayViewController: TodayViewController, _ page: Int) {
//        Alamofire
//            .request("\(self.appDelegate.baseUrl)/news-products?page=\(page)", method: .get)
//            .validate()
//            .responseObject(completionHandler: { (response: DataResponse<NewBestResponse>) in
